...
export default function Footer() {
  return (
    <footer className='container mx-auto px-8'>
        <div className='grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t 
            border-gray-100  lg:grid-cols-4'
        >
            ...
            <div className='flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0 space-y-4'>
                ...
                <Link to='/contact' className='w-full text-gray-500 rounded-md hover:text-violet-500 focus:text-violet-500'>
