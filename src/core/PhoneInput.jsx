    ...
    return (
        <div className='flex flex-col space-y-4 w-full'>
            ...
            <div className='flex items-center space-x-2'>
                <select name="code" value={phone.code} onChange={(e) => setphone(pre => ({ ...pre, code: e.target.value }))} id="code" className='h-12 px-1 rounded-md border focus:border-violet-600  bg-violet-100 '>
                    <option value="+91" >IN +91</option>
                    <option value="+1" >CAD +1</option>
                ...
                <input type={props.type || 'text'} name={props.name} id={props.id} disabled={props.disabled}
                    ...
                    className="h-12 w-full px-2 rounded-md focus:border-violet-600 focus:border bg-violet-100
